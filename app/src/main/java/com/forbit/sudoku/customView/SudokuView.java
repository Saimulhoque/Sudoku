package com.forbit.sudoku.customView;
...
import com.forbit.sudoku.AppPreference;
...
public class SudokuView extends View {
    ...
    private void init(){
        ...
        basic = sudokuGenerator.basicLevel();
    ...
    public void restart(){
       /* AppPreference.getInstance(this.getContext()).setFinalArray(finalArr);
        AppPreference.getInstance(this.getContext()).setFinalArray(basic);
        isRestart=true;*/
